...
import svgPaths from "./svg-tfwjildk35";
...
function BackgroundImage5({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage5Props>) {
  return (
    <div className={clsx("min-h-[41.401222229003906px] min-w-[106.46028137207031px] relative rounded-br-[4px] rounded-tr-[4px]", additionalClassNames)}>
...
function ComListLevelBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage6 additionalClassNames="w-full">
...
function NavBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage6 additionalClassNames="w-[48px]">
...
function BackgroundImage4({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage4Props>) {
  return (
    <div className={clsx("relative rounded-[5px] shrink-0", additionalClassNames)}>
...
function Frame1321320085TagBackgroundImageAndText({ text }: Frame1321320085TagBackgroundImageAndTextProps) {
  return (
    <BackgroundImage4 additionalClassNames="bg-[#f8f8f8]">
...
export default function Component() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="5" style={{ backgroundImage: "linear-gradient(90deg, rgb(248, 248, 248) 0%, rgb(248, 248, 248) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
                        ...
                        <div className="content-stretch flex gap-[8px] items-center px-[8px] py-[5px] relative w-full">
                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start justify-center min-h-px min-w-px relative" data-name="content">
                            <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
                              ...
                              <FrameBackgroundImage1>
                                <g clipPath="url(#clip0_1_20353)" id="Frame">
                    ...
                    <div className="content-stretch flex flex-col gap-[8px] items-start p-[16px] relative size-full">
                      ...
                      <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                        <div className="content-start flex flex-wrap gap-[6px] items-start relative shrink-0 w-full">
                          <BackgroundImage4 additionalClassNames="bg-[#e2e2e2]">
                        ...
                        <div className="absolute h-[6.608px] left-[5.41px] top-[32.82px] w-[30.231px]">
                          <div className="absolute inset-[-122.61%_-26.8%]">
                            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46.4346 22.8108">
                              <g filter="url(#filter0_f_1_20914)" id="Ellipse 1208">
                                <ellipse cx="23.2173" cy="11.4054" fill="var(--fill-0, #48669C)" fillOpacity="0.3" rx="15.1157" ry="3.30377" />
                              </g>
                              <defs>
                                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22.8108" id="filter0_f_1_20914" width="46.4346" x="0" y="0">
                                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                                  <feGaussianBlur result="effect1_foregroundBlur_1_20914" stdDeviation="4.05081" />
                                </filter>
                              </defs>
                            </svg>
                          </div>
                        ...
                        <div className="absolute h-[2.607px] left-[13.01px] top-[34.41px] w-[15.026px]">
                          <div className="absolute inset-[-97.12%_-16.85%]">
                            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.0893 7.67043">
                              <g filter="url(#filter0_f_1_21069)" id="Ellipse 1209">
                                <ellipse cx="10.0446" cy="3.83521" fill="var(--fill-0, #48669C)" fillOpacity="0.3" rx="7.51287" ry="1.30346" />
                              </g>
                              <defs>
                                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="7.67043" id="filter0_f_1_21069" width="20.0893" x="0" y="0">
                                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                                  <feGaussianBlur result="effect1_foregroundBlur_1_21069" stdDeviation="1.26588" />
                                </filter>
                              </defs>
                            </svg>
                          </div>
                              ...
                              <div className="relative shrink-0 w-full">
                                <div className="content-stretch flex gap-[10px] items-start pl-[8px] relative w-full">
                                  ...
                                  <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
                                    <BackgroundImage5 additionalClassNames="bg-[#fbfbfb] shrink-0 w-full">
                                      <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px opacity-30 relative" data-name="content">
                                        ...
                                        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                          <TitleBackgroundImage text="索赔详情分析" text1="等待中..." additionalClassNames="gap-[5.914px]" />
                                    ...
                                    <div className="content-stretch flex items-center overflow-clip relative rounded-[4px] shrink-0 w-full">
                                      <BackgroundImage5 additionalClassNames="bg-[#fbfbfb] flex-[1_0_0]">
                                        <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px opacity-30 relative" data-name="content">
                                          <CheckboxBackgroundImage>
                                            <div className="shrink-0 size-[12px]" data-name="empty" />
                                          </CheckboxBackgroundImage>
                                          ...
                                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                            <TitleBackgroundImage text="[A2A]将分析结论发送给博世Agent" text1="等待中..." additionalClassNames="gap-[11.91px]" />
                                            <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
                                              <p className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[#7c7c7c] text-[11px] tracking-[0.88px] uppercase whitespace-nowrap">负责人:</p>
                                              <CellPrimitiveBackgroundImageAndText text="连小山" />
                                              <div className="content-stretch flex gap-[4px] h-[16px] items-center relative shrink-0" data-name="cell-primitive">
                                                <div className="bg-white h-[14.787px] overflow-clip relative shrink-0 w-[16px]">
                                                  <div className="absolute h-[20.22px] left-[-2.94px] pointer-events-none top-[-2.71px] w-[21.879px]" data-name="Flow 1@512p-25fps 2">
                                                    <img alt="" className="absolute inset-0 max-w-none object-cover size-full" src={imgFlow1512P25Fps2} />
                                                    <div aria-hidden="true" className="absolute border border-black border-solid inset-0" />
                                                  </div>
                                                </div>
                                                <div className="flex flex-col font-['LiciumFont_2022:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#7c7c7c] text-[11px] whitespace-nowrap">
                                                  <p className="leading-[1.15]">博世Agent</p>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                      ...
                                      <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px opacity-30 relative" data-name="content">
                                        ...
                                        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                          ...
                                          <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
                                            <p className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[#7c7c7c] text-[11px] tracking-[0.88px] uppercase whitespace-nowrap">负责人:</p>
                                            <CellPrimitiveBackgroundImageAndText text="连小山" />
                                            <div className="h-[16px] shrink-0 w-[74px]" data-name="cell-primitive" />
                                          </div>
                                        </div>
                                      </div>
                                    </BackgroundImage5>
                                    <div className="content-stretch flex items-center overflow-clip relative rounded-[4px] shrink-0 w-full">
                                      <BackgroundImage5 additionalClassNames="bg-[#e7f0ff] flex-[1_0_0]">
                                        <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="content">
                                          <CheckboxBackgroundImage>
                                            <div className="shrink-0 size-[12px]" data-name="empty" />
                                          </CheckboxBackgroundImage>
                                          <p className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.75] not-italic relative shrink-0 text-[15px] text-[rgba(0,0,0,0.3)] text-center tracking-[0.3px] w-[16px]">5.</p>
                                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                            <div className="content-stretch flex gap-[5.914px] items-center relative shrink-0 w-full" data-name="title">
                                              <p className="flex-[1_0_0] font-['LiciumFont_2022:Regular',sans-serif] leading-[1.15] min-h-px min-w-px not-italic relative text-[#171717] text-[13px] tracking-[0.065px]">闭环验证</p>
                                            ...
                                            <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
                                              <p className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[#7c7c7c] text-[11px] tracking-[0.88px] uppercase whitespace-nowrap">负责人:</p>
                                              <div className="content-stretch flex h-[16px] items-center relative shrink-0" data-name="cell-primitive">
                                                <div className="h-[16px] relative shrink-0" data-name="cell-primitive">
                                                  <div className="flex flex-row items-center size-full">
                                                    <div className="content-stretch flex gap-[4px] h-full items-center relative">
                                                      <div className="content-stretch flex items-center relative shrink-0" data-name="prefix">
                                                        <div className="relative rounded-[100px] shrink-0" data-name="type=image, size=xs, status=none, circular=true">
                                    ...
                                    <div className="content-stretch flex h-[51px] items-center overflow-clip rounded-[4px] shrink-0 w-full" />
                                  </div>
                                </div>
                              </div>
                            </div>
                                ...
                                <div className="content-stretch flex flex-col gap-[12px] items-start pt-[16px] relative size-full">
                                  ...
                                  <div className="relative shrink-0 w-full">
                                    <div className="content-stretch flex flex-col gap-[16px] items-start px-[16px] relative w-full">
                                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                                        <div className="relative shrink-0 w-full">
                                          <div className="content-stretch flex flex-col items-start px-[16px] relative w-full">
                                            <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="默认">
                                                      ...
                                                      <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                                                        <div className="content-stretch flex items-center relative shrink-0 w-full">
                                                          <div className="content-stretch flex flex-[1_0_0] gap-[5px] items-center justify-center min-h-px min-w-px relative">
                                                            <p className="flex-[1_0_0] font-['LiciumFont_2022:Medium',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] tracking-[-0.07px]">闭环验证</p>
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
                                                          <p className="font-['LiciumFont_2022:Medium',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#171717] text-[12px] tracking-[-0.06px] w-full">需要明确闭环验证方式</p>
                                                          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                                                            <div className="bg-[#f3f3f3] relative rounded-[4px] shrink-0 w-full">
                                                              <div className="content-stretch flex flex-col gap-[12px] items-start p-[8px] relative w-full">
                                                                <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                                                                  <div className="bg-white relative rounded-[4px] shrink-0 w-full" data-name="input-textarea">
                                                                    <div aria-hidden="true" className="absolute border border-[#e2e2e2] border-solid inset-0 pointer-events-none rounded-[4px]" />
                                                                    <div className="flex flex-row items-center justify-center size-full">
                                                                      <div className="content-stretch flex gap-[6px] items-center justify-center px-[8px] py-[6px] relative w-full">
                                                                        <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative" data-name="container">
                                                                          <p className="flex-[1_0_0] font-['LiciumFont_2022:Regular',sans-serif] leading-[1.6] min-h-px min-w-px not-italic overflow-hidden relative self-stretch text-[#999] text-[12px] text-ellipsis tracking-[-0.06px] whitespace-nowrap">请描述验证的方式，明确验证时长、验证范围和通过标准，例如【持续收集问题批次零件1个月内的售后数据，只要发现有相同原因的售后工单，就代表闭环失败】...</p>
                                                                          <div className="bg-[#f3f3f3] h-[60px] shrink-0 w-0" data-name="min-height" />
                                                                        </div>
                                                                        <div className="absolute bottom-[4px] right-[4px] size-[12px]" data-name="icon/line/resizer">
                                                                          <div className="absolute inset-[48.96%_5.25%_5.23%_48.96%]" data-name="Union">
                                                                            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.49457 5.49769">
                                                                              <path d={svgPaths.p2f6a2880} fill="var(--fill-0, #999999)" id="Union" />
                                                                            </svg>
                                                                          </div>
                                                                        </div>
                                                                      </div>
                                                                ...
                                                                <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full">
                                                                  <div className="bg-white flex-[1_0_0] h-[30px] min-h-px min-w-px relative rounded-[5px]" data-name="button">
                                                                    <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                                                                      <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[6px] relative size-full">
                                                                        <div className="flex flex-col font-['LiciumFont_2022:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#383838] text-[14px] tracking-[0.07px] whitespace-nowrap">
                                                                          <p className="leading-[1.15]">重置</p>
                                                                        </div>
                                                                      </div>
                                                                    </div>
                                                                    <div aria-hidden="true" className="absolute border border-[#e2e2e2] border-solid inset-0 pointer-events-none rounded-[5px]" />
                                                                  </div>
                                                      ...
                                                      <div className="h-0 relative shrink-0 w-full">
                                                        <div className="absolute inset-[-0.5px_0]">
                                                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 251 1">
                                                            <path d="M0 0.5H251" id="Vector 4724" stroke="var(--stroke-0, #EDEDED)" />
                                                          </svg>
                                                        </div>
                                                      </div>
                                                      <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full">
                                                        <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-h-px min-w-px opacity-30 relative">
                                                          <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                                                            <div className="relative shrink-0 size-[16px]">
                                      ...
                                      <div className="h-[276px] shrink-0 w-full" />
                                    </div>
                                  </div>
                                </div>
                              </div>
