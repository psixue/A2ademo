...
import svgPaths from "./svg-2yly5z9k5p";
                ...
                {["数据科学项目", "感知计算", "大盘", "连小山", "AI教练", "AI市场"].includes(style) && (
                  <div className={`relative shrink-0 size-[18px] ${isAnd ? "overflow-clip" : ""}`} data-name="Frame">
                    {(["数据科学项目", "感知计算"].includes(style) || isAnd1 || is1 || isAi || isAi1) && (
                      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
                        <g clipPath={isAiAndIsActive1 ? "url(#clip0_1_21262)" : isAiAndIsActive ? "url(#clip0_1_21275)" : isAiAndNotIsActive1 ? "url(#clip0_1_20733)" : isAiAndNotIsActive ? "url(#clip0_1_20435)" : isAndAndIsActive ? "url(#clip0_1_21291)" : isAndAndNotIsActive ? "url(#clip0_1_21279)" : isAndIsActive ? "url(#clip0_1_21287)" : style === "感知计算" && !isActive ? "url(#clip0_1_20439)" : undefined} id="Frame">
                        ...
                        {(is || isAnd1 || isAi || isAi1) && (
                          <defs>
                            <clipPath id={isAiAndIsActive1 ? "clip0_1_21262" : isAiAndIsActive ? "clip0_1_21275" : isAiAndNotIsActive1 ? "clip0_1_20733" : isAiAndNotIsActive ? "clip0_1_20435" : isAndAndIsActive ? "clip0_1_21291" : isAndAndNotIsActive ? "clip0_1_21279" : isAndIsActive ? "clip0_1_21287" : "clip0_1_20439"}>
...
export default function Component() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="4" style={{ backgroundImage: "linear-gradient(90deg, rgb(248, 248, 248) 0%, rgb(248, 248, 248) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
            ...
            <div className="content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start min-h-px min-w-px relative w-full">
                ...
                <NavBackgroundImage>
                  <ContentBackgroundImage>
                    <FrameBackgroundImage>
                      <g clipPath="url(#clip0_1_19191)" id="Frame">
                        <g id="Vector" />
              ...
              <div className="content-stretch flex flex-[1_0_0] flex-col gap-px items-start justify-end min-h-px min-w-px relative w-[220px]">
                ...
                <NavBackgroundImage>
                  <ContentBackgroundImage>
                    <FrameBackgroundImage>
                      <g clipPath="url(#clip0_1_19432)" id="Frame">
                        <g id="Vector" />
                        ...
                        <div className="content-stretch flex gap-[8px] items-center px-[8px] py-[5px] relative w-full">
                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start justify-center min-h-px min-w-px relative" data-name="content">
                            <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
                              ...
                              <FrameBackgroundImage1>
                                <g clipPath="url(#clip0_1_19163)" id="Frame">
                        ...
                        <div className="absolute h-[6.608px] left-[5.41px] top-[32.82px] w-[30.231px]">
                          <div className="absolute inset-[-122.61%_-26.8%]">
                            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46.4346 22.8108">
                              <g filter="url(#filter0_f_1_19218)" id="Ellipse 1208">
                                <ellipse cx="23.2173" cy="11.4054" fill="var(--fill-0, #48669C)" fillOpacity="0.3" rx="15.1157" ry="3.30377" />
                              </g>
                              <defs>
                                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="22.8108" id="filter0_f_1_19218" width="46.4346" x="0" y="0">
                                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                                  <feGaussianBlur result="effect1_foregroundBlur_1_19218" stdDeviation="4.05081" />
                                </filter>
                              </defs>
                            </svg>
                          </div>
                        ...
                        <div className="absolute h-[2.607px] left-[13.01px] top-[34.41px] w-[15.026px]">
                          <div className="absolute inset-[-97.12%_-16.85%]">
                            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.0893 7.67043">
                              <g filter="url(#filter0_f_1_19286)" id="Ellipse 1209">
                                <ellipse cx="10.0446" cy="3.83521" fill="var(--fill-0, #48669C)" fillOpacity="0.3" rx="7.51287" ry="1.30346" />
                              </g>
                              <defs>
                                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="7.67043" id="filter0_f_1_19286" width="20.0893" x="0" y="0">
                                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                                  <feGaussianBlur result="effect1_foregroundBlur_1_19286" stdDeviation="1.26588" />
                                </filter>
                              </defs>
                            </svg>
                          </div>
                                        ...
                                        <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="content">
                                          ...
                                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                            <div className="content-stretch flex gap-[5.914px] items-center relative shrink-0 w-full" data-name="title">
                                              <p className="flex-[1_0_0] font-['LiciumFont_2022:Regular',sans-serif] leading-[1.15] min-h-px min-w-px not-italic relative text-[#171717] text-[13px] tracking-[0.065px]">生成完整报告</p>
                                                ...
                                                <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                                                  <div className="content-stretch flex items-center relative shrink-0 w-full">
                                                    <div className="content-stretch flex flex-[1_0_0] gap-[5px] items-center justify-center min-h-px min-w-px relative">
                                                      <p className="flex-[1_0_0] font-['LiciumFont_2022:Medium',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] tracking-[-0.07px]">生成完整报告</p>
                                                    </div>
                                                  </div>
                                                  <div className="bg-[#f3f3f3] relative rounded-[4px] shrink-0 w-full">
                                                    <div className="content-stretch flex flex-col items-start p-[8px] relative w-full">
                                                      <p className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#383838] text-[12px] tracking-[-0.06px] w-full">结合连小山和博世Agent的分析结论，汇总生成完整分析报告</p>
                                                    </div>
                                                  </div>
                                                  <div className="bg-white h-[30px] relative rounded-[5px] shrink-0 w-full" data-name="button">
                                                    <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                                                      <div className="content-stretch flex gap-[8px] items-center justify-center px-[8px] py-[6px] relative size-full">
                                                        <div className="flex flex-col font-['LiciumFont_2022:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#383838] text-[14px] tracking-[0.07px] whitespace-nowrap">
                                                          <p className="leading-[1.15]">查看分析报告</p>
                                                        </div>
                                                      </div>
                                                    </div>
