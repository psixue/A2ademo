...
import svgPaths from "./svg-8zb44ntpqu";
...
function ComListLevelBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage7 additionalClassNames="w-full">
...
function NavBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <BackgroundImage7 additionalClassNames="w-[48px]">
...
function BackgroundImage4({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage4Props>) {
  return (
    <BackgroundImage8 additionalClassNames={clsx("relative rounded-[5px] shrink-0", additionalClassNames)}>
...
function BadgeBackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<BadgeBackgroundImageProps>) {
  return (
    <BackgroundImage8 additionalClassNames={clsx("relative rounded-[100px] shrink-0", additionalClassNames)}>
...
export default function Component() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="6" style={{ backgroundImage: "linear-gradient(90deg, rgb(248, 248, 248) 0%, rgb(248, 248, 248) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
                                    ...
                                    <div className="content-stretch flex items-center overflow-clip relative rounded-[4px] shrink-0 w-full">
                                      <BackgroundImage5 additionalClassNames="bg-[#e7f0ff] flex-[1_0_0]">
                                        <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="content">
                                          ...
                                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                            <div className="content-stretch flex font-['LiciumFont_2022:Regular',sans-serif] gap-[5.914px] items-center leading-[1.15] not-italic relative shrink-0 w-full" data-name="title">
                                              <p className="flex-[1_0_0] min-h-px min-w-px relative text-[#171717] text-[13px] tracking-[0.065px]">闭环验证</p>
                                              <p className="relative shrink-0 text-[#48669c] text-[11px] tracking-[0.88px] uppercase whitespace-nowrap">1月15日10:30</p>
                                            </div>
                                            <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-full">
                                              <p className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[#7c7c7c] text-[11px] tracking-[0.88px] uppercase whitespace-nowrap">负责人:</p>
                                                        ...
                                                        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                                                          <div className="bg-[#f3f3f3] relative rounded-[4px] shrink-0 w-full">
                                                            <div className="content-stretch flex flex-col items-start p-[8px] relative w-full">
                                                              <div className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#383838] text-[12px] tracking-[-0.06px] w-full">
                                                                <p className="mb-0">经过一个月的持续监控，连小山未发现新问题产生。</p>
                                                                <p>索赔闭环验证通过。</p>
                                                              </div>
                                                            </div>
                                                          </div>
