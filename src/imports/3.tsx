...
import svgPaths from "./svg-r7wefk07kf";
...
export default function Component() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="3" style={{ backgroundImage: "linear-gradient(90deg, rgb(248, 248, 248) 0%, rgb(248, 248, 248) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
                                ...
                                <div className="content-stretch flex gap-[10px] items-start pl-[8px] relative w-full">
                                  ...
                                  <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative">
                                    <div className="content-stretch flex items-center overflow-clip relative rounded-[4px] shrink-0 w-full">
                                      <BackgroundImage5 additionalClassNames="bg-[#fbfbfb]">
                                    ...
                                    <div className="content-stretch flex items-center overflow-clip relative rounded-[4px] shrink-0 w-full">
                                      <BackgroundImage5 additionalClassNames="bg-[#fbfbfb]">
                                        <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px opacity-30 relative" data-name="content">
                                          ...
                                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                            <TitleBackgroundImage text="[A2A]将分析结论发送给博世Agent" text1="等待中..." additionalClassNames="gap-[5.914px]" />
                                    ...
                                    <div className="content-stretch flex items-center overflow-clip relative rounded-[4px] shrink-0 w-full">
                                      <BackgroundImage5 additionalClassNames="bg-[#e7f0ff]">
                                        <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative" data-name="content">
                                          ...
                                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                                            <div className="content-stretch flex gap-[5.914px] items-center relative shrink-0 w-full" data-name="title">
                                              <p className="flex-[1_0_0] font-['LiciumFont_2022:Regular',sans-serif] leading-[1.15] min-h-px min-w-px not-italic relative text-[#171717] text-[13px] tracking-[0.065px]">[A2A]从博世Agent获取分析数据</p>
                                                ...
                                                <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                                                  ...
                                                  <div className="bg-[#f3f3f3] relative rounded-[4px] shrink-0 w-full">
                                                    <div className="content-stretch flex flex-col items-start p-[8px] relative w-full">
                                                      <p className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#383838] text-[12px] tracking-[-0.06px] w-full">博世Agent已完成分析，连小山成功接收博世Agent分析结论</p>
                                                    </div>
                                                  </div>
                                            ...
                                            <div className="bg-[#e7f0ff] flex-[1_0_0] min-h-px min-w-px relative rounded-[4px]">
                                              ...
                                              <div className="content-stretch flex flex-col items-start p-[12px] relative w-full">
                                                <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                                                  <div className="content-stretch flex items-center relative shrink-0 w-full">
                                                    <div className="content-stretch flex flex-[1_0_0] gap-[5px] items-center justify-center min-h-px min-w-px relative">
                                                      <p className="flex-[1_0_0] font-['LiciumFont_2022:Medium',sans-serif] leading-[1.5] min-h-px min-w-px not-italic relative text-[#171717] text-[14px] tracking-[-0.07px]">[A2A]从博世Agent获取分析数据</p>
                                                    </div>
                                                  </div>
                                                  <div className="relative rounded-[4px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(255, 255, 255, 0.5) 0%, rgba(255, 255, 255, 0.5) 100%), linear-gradient(90deg, rgb(243, 243, 243) 0%, rgb(243, 243, 243) 100%)" }}>
                                                    <div className="overflow-clip rounded-[inherit] size-full">
                                                      <div className="content-stretch flex flex-col items-start p-[8px] relative w-full">
                                                        <div className="font-['LiciumFont_2022:Regular',sans-serif] leading-[1.6] not-italic relative shrink-0 text-[#7c7c7c] text-[12px] tracking-[-0.06px] w-full">
                                                          <p className="mb-0">已经完成分析，结合连小山数据，得到以下分析结论：</p>
                                                          <p className="mb-0">• 1号零件失效根因为xx，已调整产线参数</p>
                                                          <p className="mb-0">• 2号零件失效根因未NTF，怀疑偶发故障</p>
                                                          <p className="mb-0">• 3号零件失效根因为xx，已调整产线参数</p>
                                                          <p>
                                                            • 4号零件失效根因为xx，需要
                                                            <br aria-hidden="true" />
                                                            完整数据已生成分析报告
